...
function repeatsKnownNoProgressStep(decision,steps=[]){
  ...
  return array(steps).some(step=>{
    if(step?.worker!==decision.worker||step?.changed!==false)return false;
